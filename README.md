...
_See code: [src/commands/add/index.ts](https://github.com/tode/tode/blob/v0.1.1/src/commands/add/index.ts)_
...
_See code: [src/commands/add/auth.ts](https://github.com/tode/tode/blob/v0.1.1/src/commands/add/auth.ts)_
...
_See code: [src/commands/add/controller.ts](https://github.com/tode/tode/blob/v0.1.1/src/commands/add/controller.ts)_
...
_See code: [src/commands/add/model.ts](https://github.com/tode/tode/blob/v0.1.1/src/commands/add/model.ts)_
...
_See code: [src/commands/add/resource.ts](https://github.com/tode/tode/blob/v0.1.1/src/commands/add/resource.ts)_
...
_See code: [src/commands/add/service.ts](https://github.com/tode/tode/blob/v0.1.1/src/commands/add/service.ts)_
...
_See code: [src/commands/create-project/index.ts](https://github.com/tode/tode/blob/v0.1.1/src/commands/create-project/index.ts)_
